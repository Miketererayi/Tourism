            ...
            <div class="sidebar-card" style="box-shadow: var(--shadow); border: 1px solid var(--border); padding: 1.5rem; border-radius: var(--radius);">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <input type="text" name="name" class="form-control" placeholder="Name" aria-label="Your Name" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <input type="email" name="email" class="form-control" placeholder="Email" aria-label="Your Email" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1.25rem;">
                        <textarea name="message" class="form-control" rows="3" placeholder="Message" aria-label="Your Message" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;"></textarea>
                    </div>
