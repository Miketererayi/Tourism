            ...
            <div class="sidebar-card" style="box-shadow: var(--shadow); border: 1px solid var(--border); padding: 1.5rem; border-radius: var(--radius);">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <label for="visit_name" class="sr-only">Name</label>
                        <input type="text" id="visit_name" name="name" class="form-control" placeholder="Name" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <label for="visit_email" class="sr-only">Email</label>
                        <input type="email" id="visit_email" name="email" class="form-control" placeholder="Email" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1.25rem;">
                        <label for="visit_message" class="sr-only">Message</label>
                        <textarea id="visit_message" name="message" class="form-control" rows="3" placeholder="Message" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;"></textarea>
                    </div>
