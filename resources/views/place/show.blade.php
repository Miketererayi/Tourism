            ...
            <div class="sidebar-card" style="box-shadow: var(--shadow); border: 1px solid var(--border); padding: 1.5rem; border-radius: var(--radius);">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <input type="text" name="name" aria-label="Name" class="form-control" placeholder="Name" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1rem;">
                        <input type="email" name="email" aria-label="Email" class="form-control" placeholder="Email" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;">
                    </div>
                    
                    <div class="form-group" style="margin-bottom: 1.25rem;">
                        <textarea name="message" aria-label="Message" class="form-control" rows="3" placeholder="Message" required style="font-size:0.9rem; padding: 0.6rem 0.85rem;"></textarea>
                    </div>
